<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"C:\php\server\Apache24\htdocs\twothink\public/../application/home/view/default/index\index.html";i:1507472751;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="__STATIC__/image/index.png" width="100%" />
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo url('article/lists?category=45'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('article/lists?category=44'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('article/lists?category=46'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('sale/index'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('article/lists?category=43'); ?>">
