<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:95:"C:\php\server\Apache24\htdocs\twothink\public/../application/home/view/default/sale\detail.html";i:1507332196;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布者:<?php echo $info['nickname']; ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo $info['create_time']; ?></div>
        <div class="noticeDetailInfo">联系电话：<?php echo $info['phone']; ?></div>
        <h4 class="text-danger">价格:<?php echo $info['price']; ?>元/月</h4>
