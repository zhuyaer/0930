<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/subject\index.html";i:1507329792;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn" href="<?php echo url('add?qid='.$qid); ?>">新 增</a>
        ...
        <table class="">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('subject/edit?id='.$vo['id'].'&qid='.$qid); ?>" class="authorize">编辑</a>
                        <a href="<?php echo url('subject/del?id='.$vo['id']); ?>" class="authorize">删除</a>
                    </td>
                </tr>
