<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/owner\index.html";i:1507317669;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <table class="">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('Own/del?id='.$vo['id']); ?>" class="confirm ajax-get">删除</a>
                    </td>
                </tr>
