<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:103:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/questionnaire\edit.html";i:1507323103;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2><?php echo isset($info['id'])?'编辑':'新增'; ?>问卷</h2>
</div>
<div class="tab-wrap">
            ...
            <div id="tab1" class="tab-pane in tab1">
                ...
                <div class="form-item">
                    <label class="item-label">
                        标题<span class="check-tips">（问卷名称不能为空）</span>
                    </label>
                    <div class="controls">
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <input type="text" class="text time" name="deadline" value="<?php echo (isset($info['deadline']) && ($info['deadline'] !== '')?$info['deadline']:''); ?>">
                    </div>
                </div>
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <label class="inline radio"><input type="radio" name="use" value="1" checked>是</label>
                        <label class="inline radio"><input type="radio" name="use" value="0">否</label>
                    </div>
                </div>
