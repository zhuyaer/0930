<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/model\add.html";i:1496373782;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
		...
		<div class="tab-content">
			...
			<form id="form" action="<?php echo url('update'); ?>" method="post" class="form-horizontal doc-modal-form">
				...
				<div id="tab1" class="tab-pane in tab1">
					...
					<div class="form-item cf">
						<label class="item-label">模型类型<span class="check-tips">（选择要继承的模型）</span></label>
						<div class="controls">
							<select name="extend">
