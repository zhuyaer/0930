<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/subject\edit.html";i:1507328231;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2><?php echo isset($info['id'])?'编辑':'新增'; ?>问卷问题</h2>
</div>
<div class="tab-wrap">
            ...
            <div id="tab1" class="tab-pane in tab1">
                ...
                <div class="form-item">
                    <label class="item-label">
                        问题名称<span class="check-tips">（不能为空）</span>
                    </label>
                    <div class="controls">
                ...
                <div class="form-item">
                    <div class="controls">
                        ...
                        <select name="type">
                            <option value="1" <?php if($info['unit'] == '1'): ?>selected<?php endif; ?>>单选</option>
                            <option value="2" <?php if($info['unit'] == '2'): ?>selected<?php endif; ?>>多选</option>
                            <option value="3" <?php if($info['unit'] == '3'): ?>selected<?php endif; ?>>文本</option>
                        </select>
                    </div>
                </div>
