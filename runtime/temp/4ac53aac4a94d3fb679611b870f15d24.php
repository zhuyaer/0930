<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/property\add.html";i:1506666233;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            <label class="item-label">标题（简述保修问题）</label>
            <div class="controls">
                <input type="text" class="text input-large" name="question" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">内容（详细叙述报修内容）</label>
            <div class="controls">
