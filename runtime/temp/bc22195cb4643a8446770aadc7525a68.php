<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/attribute\index.html";i:1496373782;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="tools">
        <a class="btn" href="<?php echo url('Attribute/add?model_id='.$model_id); ?>">新 增</a>
    </div>
    ...
    <tbody>
		...
		<tr>
			...
			<td><a data-id="<?php echo $vo['id']; ?>" href="<?php echo url('Attribute/edit?id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a></td>
			<td><span><?php echo get_attribute_type($vo['type']); ?></span></td>
			<td><a href="<?php echo url('Attribute/edit?id='.$vo['id']); ?>">编辑</a>
				<a class="confirm ajax-get" href="<?php echo url('Attribute/remove?id='.$vo['id']); ?>">删除</a>
                </td>
		</tr>
