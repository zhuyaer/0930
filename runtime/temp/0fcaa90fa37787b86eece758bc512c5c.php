<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:104:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/questionnaire\index.html";i:1507328977;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <table class="">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('questionnaire/edit?id='.$vo['id']); ?>" class="authorize">编辑</a>
                        <a href="<?php echo url('subject/index?qid='.$vo['id']); ?>" class="authorize">问卷题目</a>
                    </td>
                </tr>
