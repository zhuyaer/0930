<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/sale\index.html";i:1507293997;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="cf">
        <div class="fl">
            ...
            <button class="btn ajax-post" url="<?php echo url('changeStatus?method=1'); ?>" target-form="ids">启 用</button>
            <button class="btn ajax-post" url="<?php echo url('changeStatus?method=0'); ?>" target-form="ids">禁 用</button>
            <button class="btn ajax-post confirm" url="<?php echo url('changeStatus?method=-1'); ?>" target-form="ids">删 除</button>
        </div>
        ...
        <table class="">
            ...
            <?php if(!(empty($_list) || (($_list instanceof \think\Collection || $_list instanceof \think\Paginator ) && $_list->isEmpty()))): if(is_array($_list) || $_list instanceof \think\Collection || $_list instanceof \think\Paginator): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><span><?php echo $vo['deadline']; ?></span></td>
                    <td><?php echo $vo['status']; ?></td>
                    <td>
                        <a href="<?php echo url('Sale/edit?id='.$vo['id']); ?>" class="authorize">编辑</a>
                        <a href="<?php echo url('Sale/del?id='.$vo['id']); ?>" class="confirm ajax-get">删除</a>
                    </td>
                </tr>
