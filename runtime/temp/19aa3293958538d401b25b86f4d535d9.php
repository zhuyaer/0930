<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/sale\edit.html";i:1507294122;s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <div class="form-item">
                    ...
                    <div class="controls">
                        <select style="width: 200px;" name="type">
                            <option value="1" <?php if($info['type'] == '1'): ?>selected<?php endif; ?>>出租</option>
                            <option value="2" <?php if($info['type'] == '2'): ?>selected<?php endif; ?>>销售</option>
                        </select>
                    </div>
                </div>
