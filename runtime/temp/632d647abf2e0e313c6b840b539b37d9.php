<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\php\server\Apache24\htdocs\twothink\public/../application/home/view/default/my\index.html";i:1507314169;}*/ ?>
...
<div class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="__STATIC__/image/5.png" width="60" height="60" />
            </div>
            <div class="col-xs-8">
                <?php echo $info['nickname']; ?><br/>
                北大花园小区<br/>
                积分:<span class="text-danger"><?php echo $info['score']; ?></span>
            </div>
            <div class="col-xs-1">
                <br>
                <div><a href="<?php echo url('my/sign'); ?>" class="text-primary">签到</a></div>
                <div><a href="<?php echo url('login/logout'); ?>" class="text-danger">注销</a></div>
            </div>
        </div>
        <div class="blank"></div>
