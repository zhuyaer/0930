<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"C:\php\server\Apache24\htdocs\twothink\public/../application/home/view/default/faxian\index.html";i:1507472768;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="__STATIC__/image/4.png" width="100%" />
        </div>
        <div class="blank"></div>
        <div class="container">
            <ul class="list-group fuwuList">
                <li class="list-group-item"><a href="<?php echo url('article/lists?category=46'); ?>" class="text-danger"><span class="iconfont">&#xe604;</span>商家活动</a> </li>
