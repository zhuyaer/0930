...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'oG!K#lvSUnMb|+gO@7D(p0d[E1qsJV4eX<cmPN/r', //默认数据加密KEY
	'data_cache_key'=> 'oG!K#lvSUnMb|+gO@7D(p0d[E1qsJV4eX<cmPN/r',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'oG!K#lvSUnMb|+gO@7D(p0d[E1qsJV4eX<cmPN/r', //加密KEY
